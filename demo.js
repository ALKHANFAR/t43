(function(){
  ...
  var S1="أبي أحدًا يتابع كل عميل جديد خلال خمس دقائق، ويطالب بالفواتير اللي تأخرت أكثر من سبعة أيام، ويرد على أسئلة الدعم المتكررة.";
  var S5="ليش سعد ما تابع خالد الدوسري؟";
  var Q1="تابع كل عميل يترك سلته وذكّره برابط الدفع.";
  var Q2="ذكّري كل مريض قبل موعده بيوم، وإذا اعتذر اعرضي عليه أقرب موعد.";
  var Q3="طالب بالفواتير اللي تأخرت أكثر من 7 أيام، وارفع لي اللي تعدّت 30.";
  var S6="ufuq.sa";
