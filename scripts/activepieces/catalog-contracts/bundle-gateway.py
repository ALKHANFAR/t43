...
parts=[]
for f in [root/'catalog-contract.mjs',root/'catalog-selector.mjs',root.parent/'employee-design/business-fit.mjs',root.parent/'employee-design/factory-design.mjs',root.parent/'employee-design/chat-routing.mjs']:
