...
var CHATS = {
  "c1": { with:"siyadah", t:"بناء فريق المتابعة والتحصيل", when:"today", msgs:[
    { me:true,  t:"أبي أحدًا يتابع كل عميل جديد خلال خمس دقائق، ويطالب بالفواتير اللي تأخرت أكثر من سبعة أيام، ويرد على أسئلة الدعم المتكررة.", at:"14:28" },
...
var SUGG = {
  siyadah: [
    ["build","ابنِ", "أبي أحدًا يتابع الليدات ويطارد الفواتير"],
    ["ask","اسأل", "وش صار اليوم؟"],
    ["edit","عدّل", "خلّ الردود أرسمى"],
    ["link","اربط", "اربط واتساب"]
  ]
};
var CHIPS = {
  siyadah:["وش صار اليوم؟","وظّف موظف تسويق","وش ينتظرني؟"],
  saad:["كم ليد بارد عندنا؟","أوقف المتابعة مع خالد","غيّر نبرتك لأرسمى"],
...
(function(){
  ...
  function send(text){
    ...
    setTimeout(function(){
      list.push({me:false,at:now(),t:"<p>وصل. هنا تطلع الخطة قبل التنفيذ — هذا نموذج تصميمي.</p>"});
      renderThread();
    },650);
  }
