(function(){
  ...
  /* ---------- Scenes: the source of truth ---------- */
  var SCENES=[
    {id:"s0",name:"The difference", start:0,   end:8,   dark:true},
    {id:"s1",name:"One sentence",   start:8,   end:34,  dark:false},
    {id:"s3",name:"Three companies",start:34,  end:64,  dark:false},
    {id:"s4",name:"Control",        start:64,  end:82,  dark:false},
    {id:"s5",name:"Accountability", start:82,  end:98,  dark:false},
    {id:"s6",name:"Knowledge",      start:98,  end:114, dark:false},
    {id:"s8",name:"Closing",        start:114, end:120, dark:true}
  ];
  ...
  /* Typing clicks: fired as the text advances */
  ...
  /* ---------- Render: everything is a function of t ---------- */
  var S1="Follow up with every new lead within five minutes, chase invoices more than seven days late, and answer the support questions we get over and over.";
  var S5="Why didn't Saad follow up with Khalid Al-Dosari?";
  var Q1="Follow up with every customer who abandons their cart and remind them with the payment link.";
  var Q2="Remind every patient a day before their appointment. If they cancel, offer the next open slot.";
  var Q3="Chase the invoices more than 7 days late, and escalate to me any that pass 30.";
  var S6="ufuq.sa";
  ...
  function render(t){
    ...
    /* s3: three companies, 10 seconds each, same rhythm */
    ...
    $("s6tx").innerHTML = t>=105 ? "<b>Al-Ufuq company</b> · delivery solutions for restaurants in Riyadh and Jeddah<small>Read 14 pages · 4 services · prices · 9 FAQs · voice: direct and confident</small>" : "Reading ufuq.sa…<small>Pages, services, prices, FAQs</small>";
